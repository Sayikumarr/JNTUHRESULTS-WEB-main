...
const SingleResults = ({ query }) => {
  ...
  return (
    ...
    <h1 className="mt-1 block text-left mx-[12%] text-center mb-4 text-[65%] sm:text-[100%]">
        ...
        <h3 align={'right'}>This File is Auto. Generated by  &nbsp; <a className="btn text-white" style="background-color: #0088cc;" href="https://t.me/Jntuhfastresults_bot" role="button"><i className="fab fa-telegram me-2"></i>JNTU-H (BTech) Results</a></h3>
			<h4 align={'right'} >Contact Bot Admin   &nbsp; <a className="btn text-white" style="background-color: #ac2bac;" href="https://t.me/Jntuhfastresults_bot" role="button"><i className="fab fa-instagram me-2"></i>Sai Kumar Mudhiraj</a></h4>
