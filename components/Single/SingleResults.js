...
const SingleResults = ({ query }) => {
  ...
  return (
    ...
    <h1 className="mt-1 block text-left mx-[12%] text-center mb-4 text-[65%] sm:text-[100%]">
        ...
        <h3 align={'right'}>This File is Auto. Generated by  &nbsp; <link className="btn text-white" style="background-color: #0088cc;" href="https://t.me/Jntuhfastresults_bot" role="button"><i className="fab fa-telegram me-2"></i>JNTU-H (BTech) Results</link></h3>
			<h4 align={'right'} >Contact Bot Admin   &nbsp; <link className="btn text-white" style="background-color: #ac2bac;" href="https://t.me/Jntuhfastresults_bot" role="button"><i className="fab fa-instagram me-2"></i>Sai Kumar Mudhiraj</link></h4>
			<button className="btn btn-primary btn-lg" type="button" onclick="print()"><i className="fas fa-download"></i> &nbsp; Print</button>
      </div>
      </div>
    </>
  )
