...
const Homemulti = ({ homepage }) => {
        ...
        const submits = async() => {
            ...
            return ( <
                ...
                <
                div method = "get"
                className = "mx-[0.25%] border-[3px] rounded-md border-black border-solid" >
                <
                center >
                <
                br / >
                ...
                type = "text"
                maxLength = "10"
                placeholder = "Enter From Roll Number"
                required / >
                <
                input onChange = { inputEvent }
                name = "htno_2"
                className = "my-2 content-center border-[1px] border-double border-black rounded text-rounded text-center text-[60%]  shadow-xl w-[150px] h-[28px] sm:w-[200px] sm:h-[35px] sm:text-[100%] md:my-0 sm:mx-2"
                type = "text"
                maxLength = "10"
                placeholder = "Enter To Roll Number"
                required / >
                <
                /div> <
                select name = "code"
